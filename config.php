...
$splynxBaseUrl = 'https://MYSPLYNXURL/api/2.0';

// Replace with your Splynx API Key
$apiKey = 'MYSPLYNXAPIKEY';

// Replace with your Splynx API Secret
$apiSecret = 'MYSPLYNXAPISECRET';

$googleApiKey = 'MYGOODLEMAPSAPIKEY' ;  // For geocoding should openstreetmap nominatim fail.
